...
def fit_polynomial(x_data, y_data, degree=3):
    ...
    Returns:
        dict: A dictionary containing the fitted polynomial coefficients, equation, and plot image.
    """
    # Fit the polynomial
    ...
    plt.plot(x_fit, y_fit, color='red', label=f'Fitted Curve: {formatted_equation}')
    plt.xlabel('X-axis')
    plt.ylabel('Y-axis')
